...
rTokenAbi = json.load(open("./openblocklabs_starknet_moneymarkets/protocols/hashstack/rToken.abi.json"))
dTokenAbi = json.load(open("./openblocklabs_starknet_moneymarkets/protocols/hashstack/dToken.abi.json"))
...
async def main():
    ...
    with open("./openblocklabs_starknet_moneymarkets/protocols/hashstack/tokens.json", "r") as f:
        tokens = json.load(f)
