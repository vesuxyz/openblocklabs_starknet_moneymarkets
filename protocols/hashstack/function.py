...
if __name__ == "__main__":
    ...
    # Merge decimals and prices / changed $strk and $stb on starknetAddress for Hashstack
    token_data = {
        ...
        'starknetAddress': ['0x49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7', '0x68f5c6a61780768455de69077e07e89787839bf8166decfbf92b645209c0fb8', '0x53c91253bc9682c04929ca02ed00b3e423f6710d2ee7e0d5ebb06f3ecf368a8', '0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d', '0xda114221cb83fa859dbdb4c44beeaa0bb37c7537ad5ae66fe5e0efd20e6eb3','0x0stable'],
        'decimals': [18, 6, 6, 18, 18, 1]
    }
    token_list_df = pd.DataFrame(token_data)

    final_balances = pd.merge(df, token_list_df[['starknetAddress', 'decimals']], left_on='market', right_on='starknetAddress', how='left').dropna().drop(columns='starknetAddress')
